...
if(localStorage.getItem("nav")=="1")
    document.querySelector("#topNav").checked=true;
setBlur=function(){
    blur=!blur;
...
if(localStorage.getItem("changed")==undefined){
    localStorage.setItem("changed","true");
    localStorage.setItem("themeColor","pink");
}
else if(localStorage.getItem("themeColor")!=undefined&&localStorage.getItem("changed")!=undefined){
...
toggleNav=function(){
    if(document.getElementById("topNav").checked){
