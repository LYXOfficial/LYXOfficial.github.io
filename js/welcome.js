...
if (localStorage.getItem("popWelcomeWindow") != "0") {
    if(document.referrer==undefined||document.referrer.indexOf("yaria.top")!=-1||document.referrer.indexOf("ariasaka.top")!=-1){
        Snackbar.show({
            pos: "top-right",
            showAction: false,
            text: '欢迎访问本站！'
...
if (sessionStorage.getItem("popCookieWindow") != "0") {
    Snackbar.show({
        text: '本站域名已由yisous.xyz更换为blog.yaria.top，请注意咕！',
        pos: 'top-right',
        actionText: "",
    })
    setTimeout(function () {
